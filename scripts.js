...
import { checLogin } from './module.js';
...
//Эти функции откуда ты взял? Они не нужны для твой программы. Нужно выделить часть кода,
// который используется у тебя в программе, в функцию
...
let result= checLogin(login, pass, loginPass);
alert (result);
