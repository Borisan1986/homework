...
let menu = ["pizza", "pasta", "sup", "buuza"];

let sumMenuLength = menu.reduce(function(sum, item, index, arr) {
//              итерация      1       2       3        4
...
export let vegetarianDish = dish.some(function(item, index, arr) {
    return item != "eggs","meat";
  });
  
  console.log(vegetarianDish); // true
  
//   let isContainsRolls = menu.some(function(item, index, arr) {
//     return item == "rolls";
//   });
  
//   console.log(isContainsRolls); // false